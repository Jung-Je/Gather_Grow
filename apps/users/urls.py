...
from apps.users.views.oauth_view import (
    GoogleLoginView,
    NaverLoginView,
    KakaoLoginView,
)
...
urlpatterns = [
    ...
    path("email/signup/verify/", VerifySignUpCodeView.as_view(), name="signup-email-verify"),

    # 이메일 인증 - 비밀번호 찾기
    path("email/password-reset/send/", PasswordResetEmailCodeView.as_view(), name="password-reset-email-send"),
    path("email/password-reset/verify/", VerifyPasswordResetCodeView.as_view(), name="password-reset-email-verify"),
